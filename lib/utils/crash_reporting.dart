...
import 'package:getpet/dsn.dart';
...
class CrashReporting {
  static final CrashReporting _singleton = new CrashReporting._internal();
  ...
  Future<Map<String, dynamic>> _getPlatformData() async {
    ...
    try {
      if (Platform.isAndroid) {
        deviceData = _readAndroidBuildData(await _deviceInfo.androidInfo);
